...
export function registerImageGenerateTool(server, adapter) {
    server.registerTool('image_generate', {
        title: 'Generate images',
        description: 'Generate one or more images from a text prompt through an OpenAI-compatible images/generations endpoint. Images are returned inline as base64 when available, otherwise as download URLs.',
