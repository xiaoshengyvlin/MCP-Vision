...
import { createImageGenAdapter, createVisionAdapter, getHelpText, getImageGenConfig, getRuntimeConfig, getServerMeta, isHelpRequested } from './core/config.js';
...
async function main() {
    ...
    console.error(`${meta.name} v${meta.version} running on stdio ` +
